...
namespace backend.Migrations
{
    ...
    [Migration("20250220165602_initialMigration")]
            ...
            modelBuilder.Entity("backend.Model.TempletModel", b =>
                {
                    ...
                    b.PrimitiveCollection<List<int>>("AccessList")
                        .IsRequired()
                        .HasColumnType("integer[]");
                    ...
                    b.Property<NpgsqlTsVector>("SearchVector")
                        ...
                        .HasComputedColumnSql("setweight(to_tsvector('english', coalesce(\"Title\", '')), 'A') || setweight(to_tsvector('english', coalesce(\"Description\", '')), 'B') || setweight(to_tsvector('english', coalesce(\"Topic\", '')), 'C')", true);
